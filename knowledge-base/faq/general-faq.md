...
If features still aren't visible after an hour, check Settings > Billing > Plan to confirm the
upgrade went through, then contact support if it shows Pro but features are still locked — this
resolves the majority of "missing Pro features" reports without agent involvement.

**Q: How do I report a bug?**
A: Use the in-app Feedback button (bottom-right corner) or contact support directly. Include
your browser/OS, approximately when the issue happened, and what you were doing at the time.
...
are evaluated case by case — a human always reviews these, not an automated process.
